                                        ...
                                        <div class="kobolg">
                                                ...
                                                <div class="kobolg-checkout-login">
                                                    <div class="kobolg-form-login-toggle">
                                                        <div class="kobolg-info">
                                                            Returning customer? <a href="#" class="showlogin">Click here
                                                                to login</a></div>
                                                    </div>
                                                    <form class="kobolg-form kobolg-form-login login" method="post"
                                                        ...
                                                        <div class="clear"></div>
                                                        <p class="form-row">
                                                            <input type="hidden" id="kobolg-login-nonce"
                                                                name="kobolg-login-nonce" value="832993cb93"><input
                                                                type="hidden" name="_wp_http_referer"
                                                                value="/kobolg/checkout/">
                                                            <button type="submit" class="button" name="login"
                                                                value="Login">Login</button>
                                                            <label
                                                                class="kobolg-form__label kobolg-form__label-for-checkbox inline">
                                                                <input
                                                                    class="kobolg-form__input kobolg-form__input-checkbox"
                                            ...
                                            <c:if test="${not empty cartDetails}">
                                                <form:form name="checkout" class="checkout kobolg-checkout"
                                                    action="/place-order" method="post" modelAttribute="cart">
                                                    ...
                                                    <c:if test="${not empty cartDetails}">
                                                        <div class="col2-set" id="customer_details">
                                                            <div class="col-1">
                                                                        ...
                                                                        <p class="form-row form-row-wide">
                                                                            ...
                                                                            <span class="kobolg-input-wrapper">
                                                                                <input type="text" class="input-text "
                                                                                    ...
                                                                                    value="" autocomplete="receiverName"
                                                                                    required />
                                                                            </span>
                                                                        </p>
                                                                        <p class="form-row form-row-wide">
                                                                ...
                                                                <p class="form-row form-row-wide"
                                                                    id="billing_company_field" data-priority="30"><label
                                                                        for="billing_company" class="">Company
                                                                        name&nbsp;<span
                                                                ...
                                                                <p class="form-row form-row-wide addresses-field validate-required"
                                                                    ...
                                                                    <label for="billing_addresses_1" class="">Street
                                                                        ...
                                                                        class="kobolg-input-wrapper"><input type="text"
                                                                            ...
                                                                            value="" autocomplete="addresses-line1"
                                                                            data-placeholder="House number and street name"></span>
                                                                </p>
                                                                <p class="form-row form-row-wide addresses-field"
                                                                    id="billing_addresses_2_field" data-priority="60"
                                                                    style="display: none;"><label
                                                                        for="billing_addresses_2"
                                                                        ...
                                                                        class="kobolg-input-wrapper"><input type="text"
                                                                            ...
                                                                            value="" autocomplete="addresses-line2"
                                                                ...
                                                                <p class="form-row form-row-wide addresses-field validate-state"
                                                                    ...
                                                                    data-o_class="form-row form-row-wide addresses-field validate-state">
                                                                    <label for="billing_state" class="">State /
                                                                        County&nbsp;<span
                                                                            class="optional">(optional)</span></label><span
                                                                        class="kobolg-input-wrapper"><input
                                                                            type="hidden" class="hidden"
                                                                            name="billing_state" id="billing_state"
                                                                            value="" autocomplete="addresses-level1"
                                                            ...
                                                            <p
                                                                class="form-row form-row-wide create-account kobolg-validated">
                                                                <label
                                                                    class="kobolg-form__label kobolg-form__label-for-checkbox checkbox">
                                                                    <input
                                                                        class="kobolg-form__input kobolg-form__input-checkbox input-checkbox"
                                                                        id="createaccount" type="checkbox"
                                                                        name="createaccount" value="1"> <span>Create an
                                                                        account?</span>
                                                                </label>
                                                            </p>
                                                        </div> -->
                                                                ...
                                                                <p class="form-row notes" id="order_comments_field"
                                                                    data-priority=""><label for="order_comments"
                                                                        class="">Order notes&nbsp;<span
                                                                            class="optional">(optional)</span></label><span
                                                                        class="kobolg-input-wrapper"><textarea
                                                    ...
                                                    <div id="order_review" class="kobolg-checkout-review-order">
                                                        ...
                                                        <div id="payment" class="kobolg-checkout-payment">
                                                            <ul class="wc_payment_methods payment_methods methods">
                                                                ...
                                                                <div class="payment_box payment_method_bacs">
                                                                    <p>Make your payment directly into our bank account.
                                                                        Please use your
                                                                        Order ID as the payment reference. Your order
                                                                        will not be shipped
                                                            ...
                                                            <li class="wc_payment_method payment_method_cheque">
                                                                ...
                                                                <li class="wc_payment_method payment_method_vnpay">
                                                                    ...
                                                                    <label for="payment_method_vnpay">
                                                                        ...
                                                                        <!-- <img alt="vnpay acceptance mark">
                                                                    <a href="#" class="about_vnpay">VNPAY là gì?</a> -->
                                                                    </label>
                                                                    <div class="payment_box payment_method_vnpay"
                                                                        style="display:none;">
                                                                        <p>Thanh toán qua VNPAY; có thể thanh toán bằng
                                                                            thẻ
                                                                            tín dụng nếu không có tài khoản VNPAY.</p>
                                                                    </div>
                                                                ...
                                                                <label for="payment_method_paypal">
                                                                    PayPal <img
                                                                        src="assets/images/AM_mc_vs_ms_ae_UK.png"
                                                            ...
                                                            <div class="form-row place-order">
                                                                ...
                                                                disabled, please
                                                                ensure you click the <em>Update Totals</em> button
                                                                before placing your
                                                                order. You may be charged more than the amount stated
                                                                above if you fail to
                                                                do so. <br />
                                                                <button type="submit" class="button alt"
                                                                    name="kobolg_checkout_update_totals"
                                                                    value="Update totals">
                                                                    Update totals
                                                                </button>
                                                            </noscript>
                                                            <div class="kobolg-terms-and-conditions-wrapper">
                                                                <div class="kobolg-privacy-policy-text">
                                                                    <p>Your personal data will be
                                                                        used to process your order, support your
                                                                        experience throughout this
                                                                        website, and for other purposes described in our
                                                                        <a href="#" class="kobolg-privacy-policy-link"
                                                                ...
                                                                <button type="submit" class="button alt"
                                                                    name="kobolg_checkout_place_order" id="place_order"
                                                                    value="Place order">
                                                                    Xác nhận thanh toán
                                                                </button>
                                                                <!-- <input type="hidden" id="kobolg-process-checkout-nonce"
                                                                    name="kobolg-process-checkout-nonce"
