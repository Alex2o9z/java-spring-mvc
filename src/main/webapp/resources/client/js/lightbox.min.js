! function(a) {
    a.extend(a.fn, {
        simpleCameraboxVideo: function() {
            var b = {
                delayAnimation: 300,
                keyCodeClose: 27
            };
            a.simpleCameraboxVideo.vars = a.extend({}, b);
            var c = this;
            return c.click(function() {
                ...
                return a("#slvj-window").fadeIn(), a("#slvj-video-embed").attr("src", j), a("#slvj-close-icon").click(function() {
                    a("#slvj-window").fadeOut(a.simpleCameraboxVideo.vars.delayAnimation, function() {
                        a(this).remove()
                    })
                ...
                27 == b.keyCode && a("#slvj-window").fadeOut(a.simpleCameraboxVideo.vars.delayAnimation, function() {
                    a(this).remove()
                })
...
function(a) {
    a.simpleCameraboxVideo = function(b, c) {
        return a(c).simpleCameraboxVideo()
    }
}(jQuery);